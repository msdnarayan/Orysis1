...
#input1 = tk.Entry(window, width=30, font=("Arial", 14), bd=5, insertwidth=4, borderwidth=4, relief="ridge", height=3)
input1.grid(row=0, column=0, padx=0, columnspan=4, pady=0, sticky="W")
 
clear = tk.Button( text = "C", width = 5, height = 3,command = lambda:bt_clear())
clear.grid(row = 5, column = 1, padx=0, pady=0, sticky="NSEW")
